<div class="container-fluid">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="navbar-header">
            ...
            <a href="/public/index.php"><img src="/public/assets/image/Logo_navbar-01.png" class="navbar-brand" alt="photo_logo"></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="/src/View/services.php">Conseils et Services</a></li>
                <li><a href="/src/View/contact.php">Contact</a></li>
            </ul>
        </div>
    </nav>
</div>
<div class="container-fluid info">
    <div class="row">
        <p class="col-sm-6 info_left">Du lundi au samedi de 09h à 19h</p><p class="col-sm-6"><i class="fas fa-phone phone-navbar"></i> 03.03.03.03.03</p>
    </div>
</div>